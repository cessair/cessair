const makeExtendingOrExpandingBroker = keyword =>
    function broker(descriptors, overriding = true, enumerable = false) {
        ...
        const keys = Reflect.ownKeys(descriptors).filter(key => overriding || !(key in boundary));
